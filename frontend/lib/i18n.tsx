...
const en: Record<string, string> = {
  ...
  "Бүртгэлгүй — нэр, түр нууц үг өгч шинээр үүсгэнэ; эхний нэвтрэлтэд солиулна": "Not registered — give a name and a temporary password to create the account; they must change it on first login",
  "Нууц үгээ солино уу": "Change your password",
  "Админ танд түр нууц үг өгсөн. Үргэлжлүүлэхийн өмнө зөвхөн өөрт мэдэгдэх нууц үг тавина уу.": "An administrator gave you a temporary password. Set a password only you know before continuing.",
  "Шинэ нууц үг (давтах)": "New password (repeat)",
  "Шинэ нууц үг хоёр талд таарахгүй байна": "The new passwords do not match",
  "Солих": "Change",
  "Модулийн цэс": "Module menu",
  "Хайх, шилжих": "Search and jump",
  "Хуудас хайх…": "Search pages…",
  "Олдсонгүй": "Nothing found",
  "Навигац": "Navigation",
  "Анхны тохиргоо": "First-run setup",
  "Бэлэн боллоо": "All set",
  "Платформын админ үүслээ. Одоо нэвтэрч аппаа store-оос суулга.": "The platform administrator is created. Sign in and install apps from the store.",
  "Байгууллага үүсгэж чадсангүй:": "Could not create the organisation:",
  "нэвтэрсний дараа үүсгэнэ.": "create it after signing in.",
  "Энэ суулгац аль хэдийн тохируулагдсан.": "This deployment is already set up.",
  "Шидтэн зэвсэглээгүй: API-г дахин асаагаад логоос setup холбоосыг ав, эсвэл nexus-mini.env-д ADMIN_* бичээд make migrate ажиллуул.": "The wizard is not armed: restart the API and take the setup link from its log, or put ADMIN_* into nexus-mini.env and run make migrate.",
  "API-ийн логт хэвлэгдсэн токен": "The token printed in the API log",
  "Setup токен": "Setup token",
  "Үргэлжлүүлэх": "Continue",
  "Платформын анхны админ ба (заавал биш) анхны байгууллага": "The first platform administrator and, optionally, the first organisation",
  "Байгууллагын slug": "Organisation slug",
  "Тохируулах": "Set up",
  "Энэ холбоос хүчингүй болсон — API-ийн логоос шинэ холбоосыг ав.": "This link is no longer valid — take a fresh one from the API log.",
