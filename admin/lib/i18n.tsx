...
const en: Record<string, string> = {
  "Апп алга": "No apps",
  "Байгууллага алга": "No organizations",
  "Бараан": "Dark",
  "Бичлэг алга": "No entries",
  "Дахин оролдох": "Try again",
  "Зөвхөн унших": "Read-only",
  "Имэйлийг энэ панелаас солих боломжгүй": "Email cannot be changed from this console",
  "Каталогт хараахан апп нэмэгдээгүй байна.": "No apps have been added to the catalog yet.",
  "Платформ дээр хараахан байгууллага үүсээгүй байна.": "No organizations have been created on the platform yet.",
  "Платформ дээр хараахан хэрэглэгч бүртгүүлээгүй байна.": "Nobody has signed up on the platform yet.",
  "Системийн": "System",
  "Түдгэлзүүлэх": "Suspend",
