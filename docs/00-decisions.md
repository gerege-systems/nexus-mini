...
1. **Эхний ажиллуулалт бэлэн** — татаж аваад `docker compose up` (эсвэл
   `make dev`) хийхэд DB автоматаар initialize хийгдэж, вэб рүү ороход
   `/setup` wizard админ хэрэглэгчээ үүсгүүлээд шууд эхэлдэг байх
