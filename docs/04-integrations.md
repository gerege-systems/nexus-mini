...
шалгана, `iss/aud/exp/nonce` тулгана. Имэйлээр бүртгэлтэй хэрэглэгч → session;
үгүй бол `SSO_AUTO_SIGNUP` байвал нууц үггүй данс (зөвхөн SSO-оор нэвтэрнэ).
Google-д `email_verified` заавал.
